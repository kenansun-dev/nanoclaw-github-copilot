...
function makeConfig(bindings?: any[], chats?: any): NanoclawConfig {
  return {
    agents: {
      ...
      list: [
        { id: 'main', default: true, model: 'test', name: 'Main', triggerWord: '@main', hasOwnNumber: false, mode: 'host' as const },
        { id: 'coder', model: 'test', name: 'Coder', triggerWord: '@coder', hasOwnNumber: false, mode: 'sandbox' as const },
      ],
    },
    channels: { discord: { enabled: false }, telegram: { enabled: true }, teams: { enabled: false, webhookPort: 3978, authMode: 'secret' as const } },
    mcp: { servers: {} },
    skills: { directories: [], disabled: [] },
    sandbox: { runtime: 'docker', image: 'test', timeout: 300000, maxOutputSize: 1048576, maxConcurrent: 1, idleTimeout: 0 },
    chats: chats || {},
